...
namespace UserManagement.Infrastructure.ExceptionHandling;
...
public class GlobalExceptionHandler(ILogger<GlobalExceptionHandler> logger) : IExceptionHandler
{
    ...
    {
        var statusCode = exception is AuthenticationFailedException
            ? 401
            : ExceptionStatusMapper.MapToStatusCode(exception);
